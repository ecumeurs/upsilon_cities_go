...
func CityName() string {
	...
	bodyList := [107]string{"Arramiguère", "Arrandale", "Arrastèt", "Arraulhè", "Arre", "Arrè", "Arrebentè", "Arrebot", "Arreboulh", "Arrebustalhè", "Arrec", "Arrèc", "Arredau", "Arregalh", "Arrei", "Arrélhe",
	...
	prefixList := [10]string{"Pont-de", "Le-Petit", "Le-Grand", "Petit", "Petite", "La-Petite", "La-Grande",
		"Grand", "Grande", "la-Motte"}

	suffixList := [33]string{"le-Vieux", "le-Jeune", "la-Jeune", "de-Vals", "du-Serre", "le-Bourg", "le-Chastel",
